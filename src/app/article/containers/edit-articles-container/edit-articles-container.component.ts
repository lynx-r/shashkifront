 ...
 * © Copyright
 *
 * edit-articles-container.component.ts is part of shashkifront.nosync.
 *
...
@Component({
  selector: 'app-edit-articles-container',
  templateUrl: './edit-articles-container.component.html',
  styles: []
})
        ...
        switchMap(hru => this.store.select(selectArticleEntitiesByHru)
          .pipe(
            ...
            switchMap((a: Article) => {
              ...
              return this.articleService.fetchArticle(a)
                .pipe(
